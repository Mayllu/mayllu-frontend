...
const getCategoryColor = (categoryId: number) => {
  switch (categoryId) {
    case 1: return "#FF4B4B";
    case 2: return "#4B7BFF";
    case 3: return "#FFB74B";
    case 4: return "#4BFF4B";
    ...
    >
      <View style={styles.imageContainer}>
        ...
        <View style={[styles.categoryBadge, { backgroundColor: getCategoryColor(item.categoryId) }]}>
          <Ionicons name={getCategoryIcon(item.categoryId)} size={16} color="white" />
        </View>
      </View>
      <View style={styles.contentContainer}>
        ...
        <View style={styles.footer}>
          ...
          <Text style={styles.location}>
            {item.districtId === 1 ? "UTEC" : 
              item.districtId === 2 ? "Javier Prado" :
                item.districtId === 3 ? "Miraflores" :
                  item.districtId === 4 ? "San Isidro" : "La Victoria"}
          </Text>
        </View>
      </View>
    </TouchableOpacity>
