        ...
        <View style={styles.form}>
          <Input
            ...
            icon={
              <User
                size={20}
                color={errors.name ? Colors.red_40 : Colors.white_60}
              />
            }
          />
          ...
          <Input
            ...
            icon={
              <Mail
                size={20}
                color={errors.email ? Colors.red_40 : Colors.white_60}
              />
            }
          />
          ...
          <Input
            ...
            icon={
              <ShieldCheck
                size={20}
                color={errors.dni ? Colors.red_40 : Colors.white_60}
              />
            }
          />
          ...
          <Input
            ...
            icon={
              <Lock
                size={20}
                color={errors.password ? Colors.red_40 : Colors.white_60}
              />
            }
          />
          ...
          <Link href="/auth/login" asChild>
            <Button title="Ya tengo una cuenta" variant="secondary" />
          </Link>
        </View>
      </View>
    </KeyboardAvoidingView>
